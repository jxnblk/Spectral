...
},{"./binding":2,"./config":4,"./deps-parser":5,"./directive":6,"./emitter":17,"./exp-parser":18,"./observer":22,"./text-parser":24,"./utils":26,"./viewmodel":27}],4:[function(require,module,exports){
...
},{"./emitter":17,"./observer":22,"./utils":26}],6:[function(require,module,exports){
var dirId           = 1,
    ARG_RE          = /^[\w\$-]+$/,
    FILTER_TOKEN_RE = /[^\s'"]+|'[^']+'|"[^"]+"/g,
...
},{"./text-parser":24}],7:[function(require,module,exports){
var utils = require('../utils'),
    slice = [].slice
...
},{"./config":4,"./directives":9,"./filters":19,"./observer":22,"./transition":25,"./utils":26,"./viewmodel":27}],22:[function(require,module,exports){
/* jshint proto:true */
...
},{"./emitter":17,"./utils":26}],23:[function(require,module,exports){
...
},{"./fragment":20}],24:[function(require,module,exports){
var openChar        = '{',
    endChar         = '}',
    ESCAPE_RE       = /[-.*+?^${}()|[\]\/\\]/g,
    // lazy require
...
},{"./config":4,"./fragment":20,"./template-parser.js":23,"./viewmodel":27}],27:[function(require,module,exports){
...
},{"./batcher":1,"./compiler":3,"./transition":25,"./utils":26}],28:[function(require,module,exports){
